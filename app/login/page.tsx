      ...
      <div className="hidden md:flex flex-col justify-center items-center bg-slate-900 text-white p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.8 }}>
            ...
            <h1 className="text-4xl font-bold mb-6 leading-tight">Welcome back to {siteConfig.brandName}.</h1>
            <p className="text-lg text-slate-300">Log in to manage your saved properties, track your enquiries, and discover new exclusive listings.</p>
          </motion.div>
        </div>
      </div>
